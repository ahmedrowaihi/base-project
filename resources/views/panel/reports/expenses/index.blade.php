@extends('panel.layout.master',['title' => __('panel.expense_reports'),'is_active'=>'reports'])
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('panel.expense_reports')</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
        </div>
...
@push('panel_js')
    ...
    <script>
        ...
        window.data_url = '{{route('panel.reports.expenses_reports.datatable')}}';
        window.columns = [
            {
                field: ' ',
                title: "#",
