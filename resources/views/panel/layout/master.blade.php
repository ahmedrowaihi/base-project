...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"
                     style="background-image:url('{{ asset('panelAssets/images/avatar.jpg') }}')"></div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a href="{{ route('panel.logout') }}"
                       class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">@lang('panel.logout')</a>
                </div>
            </div>
        </div>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{ route('panel.admin.profile') }}" class="navi-item">
                <div class="navi-link">
