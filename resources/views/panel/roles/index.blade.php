                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input type="text" class="form-control" name="generalSearch" placeholder="{{__('constants.search')}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="row justify-content-start">
                                            <div class="col-md-5 kt-margin-b-20-tablet-and-mobile">
                                                <button data-url="{{route('panel.permission.deleteAll')}}"
                                                        class="btn btn-sm btn-danger mr-2 deletes d-none"
                                                        type="button">{{__('constants.delete_all')}}</button>
        ...
        window.columns = [
            {
                ...
                sortable: false,
                // type: 'number',
                selector: {class: 'kt-checkbox--solid', name: 'services'},
                textAlign: 'center',
            },
            {
                field: 'name',
