<a class="btn btn-sm btn-clean btn-icon btn-icon-md operation" href=""
   data-url="{{route('panel.bank_transfers.operation', ['id' => $instance->id , 'operation' => 'accept'])}}"
   title="@lang('constants.accept')"><i class="flaticon2-check-mark"></i>
</a>

<a class="btn btn-sm btn-clean btn-icon btn-icon-md operation" href=""
   data-url="{{route('panel.bank_transfers.operation', ['id' => $instance->id , 'operation' => 'reject'])}}"
