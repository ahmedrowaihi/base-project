@extends('panel.layout.master',['title' => __('panel.' . @$status .'_bank_transfers'),'is_active'=>'financial'])
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{  __('panel.' . @$status .'_bank_transfers') }}</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
        </div>
...
@push('panel_js')
    ...
    <script>
        window.data_url = '{{route('panel.bank_transfers.status.datatable' , @$status)}}';
        window.columns = [
            {
                field: ' ',
                title: "#",
